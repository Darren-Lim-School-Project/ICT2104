...
// This will change the dutyCycle of the car to make it stop, slow down, speed up, left direction, right direction, forward direction or reverse direction
void stop(void)
{
    pwmConfig.dutyCycle = 0;
    pwm2Config.dutyCycle = 0;
    Timer_A_generatePWM(TIMER_A0_BASE, &pwmConfig);
    Timer_A_generatePWM(TIMER_A0_BASE, &pwm2Config);
}
...
// This will check if the car is running at slow speed
